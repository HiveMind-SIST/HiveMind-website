...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    if (logoSectionRef.current) {
      const socialLinks = logoSectionRef.current.querySelectorAll(
        'a[href*="github"], a[href*="linkedin"], a[href*="discord"], a[href*="instagram"]',
      );
    ...
    if (linksSectionRef.current) {
      const quickLinks =
        linksSectionRef.current.querySelectorAll('a[href^="/"]');
    ...
    <footer ref={footerRef} className="py-8 px-4 md:px-8 lg:px-32">
        ...
        <div ref={contactSectionRef} className="flex flex-col space-y-2">
          ...
          <div className="text-sm md:text-base">
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <address className="not-italic">
                    AI Supercomputing Lab - SCAS Block,
                    <br />
              ...
              <TooltipContent
                side="top"
                className="p-2 bg-background border border-border shadow-lg max-w-none"
              >
      ...
      <div ref={copyrightRef} className="text-center pt-4">
        <p className="text-xs md:text-sm">
          © 2025 Hive Mind Community. All rights reserved.
        </p>
      </div>
    </footer>
  );
